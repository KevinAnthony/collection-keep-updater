...
// GetBooksInCollection provides a mock function with given fields:
func (_m *ILibraryMock) GetBooksInCollection() (ISBNBooks, error) {
	ret := _m.Called()
	...
	if rf, ok := ret.Get(0).(func() ISBNBooks); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {

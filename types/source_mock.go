...
// ISouceMock is an autogenerated mock type for the ISource type
type ISouceMock struct {
	mock.Mock
}

// GetIDFromURL provides a mock function with given fields: url
func (_m *ISouceMock) GetIDFromURL(url string) (string, error) {
	ret := _m.Called(url)
...
func (_m *ISouceMock) GetISBNs(ctx context.Context, series Series) (ISBNBooks, error) {
...
func (_m *ISouceMock) SourceSettingFromConfig(data map[string]interface{}) ISourceSettings {
	ret := _m.Called(data)
...
// NewISouceMock creates a new instance of ISouceMock. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewISouceMock(t interface {
	mock.TestingT
	Cleanup(func())
}) *ISouceMock {
	mock := &ISouceMock{}
